...
export const SectionHero = () => {
  return (
    <section className="hero">
      <div className="overflow-hidden relative bg-white md:bg-eggWhite">
        <div className="container flex flex-col">
          {/* Background Half Triangle */}
          <div className="absolute -bottom-[480px] md:-bottom-[80px] left-0 w-full h-full bg-egg half-triangle-reverse-mobile md:half-triangle-reverse" />
          {/* Hero Image Section */}
