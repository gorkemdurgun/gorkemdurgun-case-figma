...
export const SectionBestOfTheBest = () => {
  return (
    <section className="best-of-best">
      <div className="flex flex-col items-center justify-center py-[48px] md:py-[80px] gap-[32px] md:gap-[80px] bg-darkBlue">
        {/* Best of the best heading */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between px-[16px] md:px-[80px] gap-[32px] md:gap-[80px]">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-[32px] md:gap-[48px] px-[16px] md:px-[80px]">
